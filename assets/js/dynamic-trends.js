const T = {
  ...
  fr: {
    ...
    valStratRisk:'<strong>Profil de risque</strong> — Dynamic Trends s\'adresse aux investisseurs convaincus du potentiel du Bitcoin et des actifs numériques, capables d\'accepter une volatilité plus élevée en contrepartie d\'un objectif de performance supérieur.<span class="sp-next">Le fonds accepte une exposition directionnelle significative, car celle-ci constitue le cœur de sa stratégie. Cette exposition reste toutefois pilotée, surveillée et ajustable selon le contexte de marché.</span><span class="sp-next">Sur la période analysée, le fonds affiche une perte maximale historique de -37,1 % et une volatilité annualisée de 32,8 %, inférieure à celle du Bitcoin seul sur la même période.</span>',
