const T = {
  en: {
    ...
    valStratRisk:'<strong>Risk profile</strong> — Dynamic Trends is designed for investors convinced of the potential of Bitcoin and digital assets, able to accept higher volatility in exchange for a higher performance objective.<span class="sp-next">The fund accepts significant directional exposure, as this is the core of its strategy. This exposure nonetheless remains managed, monitored and adjustable according to the market context.</span><span class="sp-next">Over the period analysed, the fund shows a historical maximum drawdown of -37.1% and an annualised volatility of 32.8%, lower than Bitcoin alone over the same period.</span>',
  ...
  fr: {
    ...
    valStratBalance:'<strong>Équilibre stratégique global</strong> — Dynamic Trends repose sur une architecture combinant un moteur directionnel principal et un bloc défensif complémentaire.<span class="sp-next">Les profits générés par les stratégies défensives peuvent être réalloués progressivement lors des rééquilibrages : ils peuvent renforcer l\'exposition lorsque les conditions deviennent favorables, ou préserver la discipline de gestion lorsque le marché devient plus incertain.</span><span class="sp-next">Cette construction vise à maintenir une exposition significative au potentiel du Bitcoin, tout en encadrant la volatilité, le drawdown potentiel et le risque global du portefeuille.</span>',
    valStratRisk:'<strong>Profil de risque</strong> — Dynamic Trends s\'adresse aux investisseurs convaincus du potentiel du Bitcoin et des actifs numériques, capables d\'accepter une volatilité plus élevée en contrepartie d\'un objectif de performance supérieur.<span class="sp-next">Le fonds accepte une exposition directionnelle significative, car celle-ci constitue le cœur de sa stratégie. Cette exposition reste toutefois pilotée, surveillée et ajustable selon le contexte de marché.</span><span class="sp-next">Sur la période analysée, le fonds affiche un drawdown maximal historique de -37,1 % et une volatilité annualisée de 32,8 %, inférieure à celle du Bitcoin seul sur la même période.</span>',
