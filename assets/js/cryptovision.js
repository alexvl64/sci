const T = {
  ...
  fr: {
    ...
    valStratIntro:'<strong>CryptoVision</strong> est la stratégie active et défensive de SparkCore. Le fonds combine une poche directionnelle pilotée et un socle market neutral afin de participer au potentiel des actifs numériques sans adopter une exposition passive permanente.<br><br>Depuis la refonte de sa stratégie en mars 2025, CryptoVision vise une exposition plus durable et résiliente aux actifs numériques, avec un drawdown maximum ciblé de 15 %. L\'allocation entre les deux blocs est ajustée dynamiquement selon les conditions de marché, la volatilité, la liquidité et le rapport rendement/risque. Le portefeuille fait l\'objet de rééquilibrages mensuels dans un cadre de gestion du risque strict.',
