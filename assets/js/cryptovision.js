const T = {
  en: {
    ...
    lblOffensiveTag:'Offensive block · 30% AUM',
  ...
  fr: {
    ...
    valDefensiveDesc:'Stratégies neutres au marché : arbitrages systémiques, modèles quantitatifs et scalping delta-neutre haute fréquence à drawdown contrôlé. Aucun levier directionnel. Génère un rendement régulier et faiblement volatile indépendamment des conditions de marché. Assure la stabilité structurelle du portefeuille.',
    lblOffensiveTag:'Bloc offensif · 30% AUM',
    lblOffensiveName:'Exposition directionnelle',
    valOffensiveDesc:'Centré sur Bitcoin, Ethereum et les crypto-actifs les plus liquides. Levier modéré, utilisé de manière opportuniste tout en maintenant un risque contrôlé. Capacité à réduire complètement l\'exposition ou à ouvrir des positions vendeuses en cas de signaux de retournement. Renforce la performance globale en phases de marché favorables.',
    valStratBalance:'<strong>Équilibre stratégique global</strong> — Rééquilibrages mensuels avec une approche disciplinée du risque alliant analyse quantitative, gestion discrétionnaire et exécution algorithmique. Le bloc défensif constitue l\'ancre structurelle tandis que le bloc offensif capte la hausse directionnelle sans compromettre la stabilité du portefeuille. Cette double architecture délivre un profil de performance plus lissé que les stratégies purement directionnelles.',
    valStratRisk:'<strong>Profil de risque</strong> — Conçu pour les investisseurs recherchant une exposition stable et maîtrisée aux crypto-actifs majeurs, CryptoVision vise une performance ajustée au risque avec un drawdown maximal historique de -22.9% et une volatilité annualisée de 32.6%. Depuis avril 2025, la stratégie a été renforcée par un socle algorithmique défensif ciblant un drawdown maximum de 15%.',
