...
const ppTranslations = {
  fr: {
    ...
    pp5NoCookieBanner: "Notre site n'utilise pas de cookies publicitaires, de tracking social ni de plateformes d'analyse telles que Google Analytics. Aucune bannière de consentement aux cookies n'est affichée, SparkCore ne déposant directement aucun cookie non essentiel.",
  ...
  en: {
    ...
    pp5NoCookieBanner: "Our website does not use advertising cookies, social media tracking, or analytics platforms such as Google Analytics. No cookie consent banner is displayed as no non-essential cookies are set by SparkCore directly.",
